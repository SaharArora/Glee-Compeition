...
| `live_simulator_alignment` | Diagnose live/offline payoff differences against fitted opponent/config assumptions without changing policy. | Large confirmation gaps did not replicate at volume; causal policy-regression premise rejected. Negotiation shortfall is not attributable from current logs because 14/35 terminal-zero incomplete-information games hide the counterpart value and therefore the true trade zone. | Volume B .441103, P .382000 (n=25 each). Complete negotiation audit n=35: known GFT 20 mean .147313; known no-trade/equality 1 mean .037752; hidden-zone zero outcomes 14. Live zero-gain responses 0/4 versus offline boundary bucket .3298, underpowered with 147/319 gains unobservable. | `candidate` | unassigned | No acting candidate diagnosed. Continue observed-config/language work; acquire authoritative full configs or an equivalent server-side zone label before estimating live no-trade exits. Normal gate required before any policy change. | `docs/FAILED.md`; `reports/live/volume_20260815` |
