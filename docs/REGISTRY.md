...
| `live_simulator_alignment` | Diagnose live/offline payoff differences against fitted opponent/config assumptions without changing policy. | Bargaining remains under active root-cause audit. Persuasion's residual buyer-rate/role premise is killed after message-mode conditioning. Negotiation's true no-trade exit rate remains unidentified because terminal-zero incomplete-information games hide the counterpart value. | Complete persuasion corpus n=60: buyer buys 164/620 overall, but binary 164/320=.5125 vs offline .4994 and yes-obedience 164/209=.7847 vs fitted .78; text 0/300. Binary buyer payoff .590 exceeds binary seller .480. All live buyer histories persist and expose no myopic flag. Complete negotiation corpus n=60: mean .079526; known GFT 37 mean .127264, known no-trade 2 mean .031414, hidden-zone zero 21. | `candidate` | bargaining root-cause | Persuasion opens no new acting family; rejected text parser remains controlling. Negotiation fallback was isolated and gate-rejected. Acquire authoritative full configs or a server-side zone label before estimating live no-trade exits. | `docs/FAILED.md`; `reports/live/confirmation_20260815`; `reports/live/volume_20260815`; `reports/live/volume2_20260815` |
