...
| `persuasion_calibration_bins` | Audit and prospectively recalibrate under-confidence in `P(high|recommend=yes)` without changing the evidence accessor. | Predictive candidate passed, but remains policy-inert. Any acting version must be defined, promotion-gated, and independently confirmed before a default flip. | Preregistered Platt candidate passed both axes. Model holdout n=17,032/1,367 games: Brier delta -0.01044, 95% clustered CI [-0.01222,-0.00873]; log loss -0.03179 [-0.03637,-0.02715]. Config holdout n=10,961/854 games: Brier -0.00858 [-0.01148,-0.00586]; log loss -0.02458 [-0.03242,-0.01694]. | `candidate` | unassigned | Shared `_persuasion_beliefs`/buy path with `persuasion_accessor`, `persuasion_explore`, and deceptive-seller work. Predictive success is not promotion-gate success. | `reports/persuasion_calibration/persuasion_calibration.json`; `glee_eval/diagnostics/persuasion.py`; `tests/test_persuasion_calibration.py` |
